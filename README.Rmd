...
`detect` = detectability in probability of a specimen being detected in a transect.   
...
`abundance`: abundance during that visit # presumably this changes through the season, but I can't see how.  #IB: Yes, it does. 
