...
#' @param mean_occ Numeric, mean expected occupancy (0-1). Default 0.25, which creates realistic occupancy values ranging from 0 to ~0.75
#'
...
#' species, as expected based on bee ecological knowledge.
#'
#' @examples
