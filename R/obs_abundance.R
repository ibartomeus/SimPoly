...
#' @param fraction_observed numeric, thefraction of individuals present this day that can be observed. Default 0.5
...
#'
obs_abundance <- function(true_abundance = NULL, sp_responses, fraction_observed = 0.5, pantrap = TRUE, n_pan = 5){
  #require(reshape)
