...
#' @param fraction_observed numeric, the fraction of individuals present this day that can be observed. Default 0.2
...
#'  proportional to its abundance, but weigthed by their probability of detection. Pantrap observations are
